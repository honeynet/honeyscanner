...
> **__NOTE__:** Currently `Honeyscanner` cannot actively attack the `Dionaea` honeypot, it can only use its passive scanners and discover vulnerabilities and CVEs.
